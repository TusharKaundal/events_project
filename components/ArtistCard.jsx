...
const ArtistCard = ({ artistData }) => {
  ...
  function handleViewEvent() {
    router.push(`/events?artist=${artistData.name}`);
  }
  return (
    <div className="hover-inverse group flex text-center justify-center transform transition-transform duration-400 hover:scale-110 hover:bg-gradient-to-r hover:from-orange-200 hover:to-white text-dark m-4 border-slate-400 border rounded-md px-8 py-2.5">
      <div>
        <img
